			...
			<ul id="accordion-menu">
				...
				<li class="dropdown">
					<a href="qlnguoimuon" class="dropdown-toggle no-arrow">
						...
						<span class="mtext">QUẢN LÍ NGƯỜI MƯỢN</span>
					</a>
				</li>
				<li class="dropdown">
					<a href="thanhli.htm" class="dropdown-toggle no-arrow">
						<span class="micon dw dw-library"></span>
						<span class="mtext">THANH LÝ</span>
					</a>
				<li>
				...
				<li>
					<a href="thanhli.htm" class="dropdown-toggle no-arrow">
						...
						<span class="mtext">THỐNG KÊ</span>
					</a>
				</li>
				<li>
					<div class="dropdown-divider"></div>
				...
				<li>
					<a href="javascript:;" class="dropdown-toggle">
						...
						<span class="mtext">QUẢN LÍ NHÂN VIÊN</span>
					</a>
				</li>
				<li>
					<a
						...
						<span class="mtext	">
							Thông tin chi tiết
							<img src="resources/vendors/images/coming-soon.png" alt=""
								width="25">
						</span>
					</a>
				</li>
