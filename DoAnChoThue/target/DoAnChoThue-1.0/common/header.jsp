	...
	<div class="header-right">
			...
			<div class="dropdown">
				...
				<div class="dropdown-menu dropdown-menu-right">
					<div class="notification-list mx-h-350 customscroll">
						<ul>
							<li><a href="#"> <img
									src="${pageContext.servletContext.contextPath}/resources/vendors/images/img.jpg"
									alt="">
									<h3>John Doe</h3>
							...
							<li><a href="#"> <img
									src="${pageContext.servletContext.contextPath}/resources/vendors/images/photo1.jpg"
									alt="">
									<h3>Lea R. Frith</h3>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing
										elit, sed...</p>
							...
							<li><a href="#"> <img
									src="${pageContext.servletContext.contextPath}/resources/vendors/images/photo2.jpg"
									alt="">
							...
							<li><a href="#"> <img
									src="${pageContext.servletContext.contextPath}/resources/vendors/images/photo3.jpg"
									alt="">
									<h3>John Doe</h3>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing
										elit, sed...</p>
							...
							<li><a href="#"> <img
									src="${pageContext.servletContext.contextPath}/resources/vendors/images/photo4.jpg"
									alt="">
			...
			<div class="dropdown">
				<a class="dropdown-toggle" href="#" role="button"
					data-toggle="dropdown"> <span class="user-icon"> <img
						src="${pageContext.servletContext.contextPath}/resources/vendors/images/photo1.jpg"
						alt="">
				</span> <span class="user-name">Ross C. Lopez</span>
				</a>
				<div
		...
		<div class="github-link">
			<a href="https://github.com/dropways/deskapp" target="_blank"><img
				src="${pageContext.servletContext.contextPath}/resources/vendors/images/github.svg"
				alt=""></a>
		</div>
	</div>
</div>
