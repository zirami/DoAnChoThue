...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.servletContext.contextPath}/resources/src/plugins/jquery-steps/jquery.steps.css">
...
<body class="login-page">
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-md-6 col-lg-7">
					<img src="${pageContext.servletContext.contextPath}/resources/vendors/images/register-page-img.png" alt="">
				</div>
		...
		<div class="modal-dialog modal-dialog-centered max-width-400" role="document">
			<div class="modal-content">
				<div class="modal-body text-center font-18">
					...
					<div class="mb-30 text-center"><img src="${pageContext.servletContext.contextPath}/resources/vendors/images/success.png"></div>
					Đăng ký thành công!
				</div>
				<div class="modal-footer justify-content-center">
					<a href="${pageContext.servletContext.contextPath}/login" class="btn btn-primary">Done</a>
				</div>
			</div>
		</div>
	</div>
	...
	<script src="${pageContext.servletContext.contextPath}/resources/src/plugins/jquery-steps/jquery.steps.js"></script>
