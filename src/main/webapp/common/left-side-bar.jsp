		...
		<div class="sidebar-menu" >
			<ul id="accordion-menu">
				...
				<li class="dropdown" id="ntb" style="display: none">
					<div class="dropdown-divider"></div> <a href="phieu-nhap"
					class="dropdown-toggle no-arrow" data-toggle="tooltip"
				...
				<li class="dropdown" id="tltb" style="display: none">
					<div class="dropdown-divider"></div> <a href="phieu-thanhly"
					class="dropdown-toggle no-arrow" data-toggle="tooltip"
					data-placement="right" title=""
				...
				<li class="dropdown" id="qltb" style="display: none">
					<div class="dropdown-divider"></div> <a href="thiet-bi"
					class="dropdown-toggle no-arrow" data-toggle="tooltip"
					data-placement="right" title=""
				...
				<li class="dropdown" id="thongke" style="display: none">
					<div class="dropdown-divider"></div> <a href="thong-ke"
					class="dropdown-toggle no-arrow" data-toggle="tooltip"
				...
				<li class="dropdown" id="qlnm" style="display: none">
					<div class="dropdown-divider"></div> <a href="qlnguoimuon"
					class="dropdown-toggle no-arrow" data-toggle="tooltip"
					data-placement="right" title=""
				...
				<li class="dropdown" id="qlnv" style="display: none">
					<div class="dropdown-divider"></div> <a href="qlnhanvien"
					class="dropdown-toggle no-arrow" data-toggle="tooltip"
					data-placement="right" title=""
