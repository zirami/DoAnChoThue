...
(function (a) {
    "object" === typeof module && module.exports
        ...
        ? define("highcharts/modules/export-data", ["highcharts", "highcharts/modules/exporting"], function (l) {
              a(l);
              a.Highcharts = l;
              return a;
          })
    ...
    l(a, "Extensions/DownloadURL.js", [a["Core/Globals.js"]], function (a) {
        ...
        a = a.downloadURL = function (a, f) {
            ...
            if ("string" === typeof a || a instanceof String || !g.msSaveOrOpenBlob) {
                ...
                if ("undefined" !== typeof n.download) (n.href = a), (n.download = f), u.body.appendChild(n), n.click(), u.body.removeChild(n);
                else
                    try {
    ...
    l(a, "Extensions/ExportData.js", [a["Core/Axis/Axis.js"], a["Core/Chart/Chart.js"], a["Core/Renderer/HTML/AST.js"], a["Core/Globals.js"], a["Core/Options.js"], a["Core/Utilities.js"], a["Extensions/DownloadURL.js"]], function (
        a,
        b,
        u,
        f,
        ...
        b.prototype.getDataRows = function (c) {
            ...
            var d = g.categoryHeader,
                ...
                v = function (p, b, e) {
                    ...
                    return p ? (p instanceof a ? (p.options.title && p.options.title.text) || (p.dateTime ? N : d) : c ? { columnTitle: 1 < e ? b : p.name, topLevelColumnTitle: p.name } : p.name + (1 < e ? " (" + b + ")" : "")) : d;
                },
                I = function (a, b, c) {
                    var p = {},
                        e = {};
            ...
            this.series.forEach(function (a) {
                ...
                if (!1 !== a.options.includeInDataExport && !a.options.isInternal && !1 !== a.visible) {
                    ...
                    var B = { chart: a.chart, autoIncrement: a.autoIncrement, options: a.options, pointArrayMap: a.pointArrayMap };
            ...
            b.push(
                (function (a, b, d) {
                    ...
                    if (e) {
                        for (e = []; h < d; ++h) {
                            ...
                            m === k
                                ? ++l
                                : l
                                ? (e.push(n("th", "highcharts-table-topheading", { scope: "col", colspan: l + 1 }, m)), (l = 0))
                                : (m === b[h] ? (c.exporting.useRowspanHeaders ? ((k = 2), delete b[h]) : ((k = 1), (b[h] = ""))) : (k = 1),
                                  (m = n("th", "highcharts-table-topheading", { scope: "col" }, m)),
                                  1 < k && m.attributes && ((m.attributes.valign = "top"), (m.attributes.rowspan = k)),
                                  e.push(m));
                        }
                    ...
                    if (b) {
                        e = [];
                        h = 0;
                        for (d = b.length; h < d; ++h) "undefined" !== typeof b[h] && e.push(n("th", null, { scope: "col" }, b[h]));
                        g.push({ tagName: "tr", children: e });
                    }
        ...
        b.prototype.downloadCSV = function () {
            var a = this.getCSV(!0);
            H(g(a, "text/csv") || "data:text/csv,\ufeff" + encodeURIComponent(a), this.getFilename() + ".csv");
        };
        ...
        b.prototype.toggleDataTable = function (a) {
            (a = x(a, !this.isDataTableVisible)) &&
                !this.dataTableDiv &&
                ((this.dataTableDiv = n.createElement("div")), (this.dataTableDiv.className = "highcharts-data-table"), this.renderTo.parentNode.insertBefore(this.dataTableDiv, this.renderTo.nextSibling));
            ...
            A && A.menuItemDefinitions && c && c.viewData && c.hideData && b && a && a.length && u.setElementHTML(a[b.indexOf("viewData")], this.isDataTableVisible ? c.hideData : c.viewData);
        };
        var A = f().exporting;
        A &&
