...
<body>
		...
		<div class="col-sm-12 col-md-6">
			<div class="form-group row">
				...
				<div class="col-sm-12 col-md-9">
					...
					<input class="form-control" value="${phieuthanhly_sua.maptl}" readonly />
					<form:input class="form-control" type="text" path="maptl"
						placeholder="Nhập mã phiếu thanh lí" required="required"
						style="display: none" />
				</div>
			</div>
			<div class="row">
		...
		<div class=" col form-group">
			<div class="row">
				<label class="col-sm-6 col-md-4 col-form-label">Nhân Viên
					chỉnh sửa:</label> <input class="col-sm-4 col-md-8 form-control"
					type="text" name="nhanvien_thanhly.manv" value="${nv.manv}"
					readonly="readonly" />
			</div>
			<div class="row">
	...
	<hr>
	<h5 class="h5 invoice-header text-center">DANH SÁCH THIẾT BỊ THANH
		LÝ</h5>
	<!-- Nhập thông tin cơ bản phiếu nhập -->
	...
	<div class="row form-group them-tb-nhap">
		<button type='button' class="form-control text-info ">
			<span class="material-icons text-info">add_circle_outline</span> Thêm
			thiết bị nhập
		</button>
	</div>
	</div>
