...
<body
					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-12 text-right">
							...
							<a href="#" class="btn  btn-info" data-toggle="modal"
								data-target="#bd-loaitb-modal-lg" type="button">Loại thiết
								bị </a>
	...
	<!--======================================================== Loại Thiết Bị ============================================================ -->
	<div class="modal fade bs-example-modal-lg" id="bd-loaitb-modal-lg"
		tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
		aria-hidden="true">
		<div class="modal-dialog modal-xl modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="pd-20 card-box mb-30">
						...
						<table
							...
							<tbody>
								<c:forEach var="ltb" items="${loaiThietBis}" varStatus="row">
									<tr>
										<td>${ltb.id}</td>
										<td>${ltb.ten}</td>
										<td class="pull-right">
			...
			<div class="modal-content">
				<div class="modal-body">
					...
					<div class="pd-20 card-box mb-30">
						...
						<form:form action="loaiTB" modelAttribute="loaithietbi_moi"
							method="post">
							<div class="form-group row">
								<label class="col-sm-12 col-md-3 col-form-label">Tên
									loại thiết bị</label>
	...
	<a hidden="true" href="#" class="btn  btn-info" id="dsLoaiTbBtn"
		data-toggle="modal" data-target="#bd-edit-loaiTB-modal-lg"
		type="button"></a>
	<!-- 	<button hidden="true" id="update_loaiTb_modal_btn" data-toggle="modal" data-target="#bd-edit-loaiTB-modal-lg"></button> -->
	<!--======================================================== Dùng để update ============================================================ -->
	<div class="modal fade bs-example-modal-lg"
		id="bd-edit-loaiTB-modal-lg" tabindex="-1" role="dialog"
			...
			<div class="modal-content">
				<div class="modal-body">
					...
					<div class="pd-20 card-box mb-30">
						...
						<form:form action="loaiTB/update" modelAttribute="loaithietbi_sua"
							method="post">
							<div class="form-group row">
								<label class="col-sm-12 col-md-3 col-form-label">Tên
									loại thiết bị</label>
								<div class="col-sm-12 col-md-9">
									<form:input path="id" class="form-control" type="text"
										placeholder="Mã loại thiết bị" required="required"
										style="display: none" />
									<form:input path="ten" class="form-control" type="text"
										placeholder="Nhập tên loại thiết bị" required="required" />
								</div>
